...
<jsp:useBean id="lesLivres" class ="com.uvsq.colinebintou.ecommerce.service.ServiceRechercheLivre" scope="session"></jsp:useBean>
			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-6 col-xs-6">
					<div class="product product-single">
						...
						<div class="product-body">
							<h3 class="product-price">32.50Euros</h3>
